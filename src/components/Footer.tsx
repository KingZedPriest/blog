  ...
  return (
    ...
    >
      <div className="mx-auto max-w-7xl px-4 py-20 text-center text-black sm:px-6 lg:px-8">
        ...
        <button className="mt-8 rounded-[2rem] border-2 px-4 py-1.5 text-white duration-500 hover:border-black hover:bg-black">
          Subscribe
        </button>
        ...
        <div className="mt-20 flex flex-col items-center justify-between sm:flex-row">
          <Link href="/">
            {" "}
            <h1 className="mt-4 text-base font-semibold duration-500 hover:text-black sm:mt-0 sm:text-lg md:text-xl lg:text-2xl">
              Vbtechgist
            </h1>{" "}
          </Link>
